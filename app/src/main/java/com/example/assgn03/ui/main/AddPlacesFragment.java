...
EditText  edcity , edstate , edcountry;
    Button btnsave;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     edstate= v.findViewById(R.id.idStreet);
      edcity = v.findViewById(R.id.idCity);
      edcountry=v.findViewById(R.id.idCountry);
...
btnsave.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
       ...
       // List<Places> placesList = new ArrayList<>();
        ...
        places.setCity(edcity.getText().toString());
        places.setCountry(edcountry.getText().toString());
        databaseRefrence = firebaseDatabase.getReference(
                "places-info"
        ).child(edstate.getText().toString());
        databaseRefrence.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             //   databaseRefrence.setValue("kabshah imran");
                databaseRefrence.setValue(places);
               // databaseRefrence.setValue(idcity.getText().toString());
               // databaseRefrence.setValue(idcountry.getText().toString());
